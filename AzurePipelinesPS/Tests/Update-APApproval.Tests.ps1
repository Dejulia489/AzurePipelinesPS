...
InModuleScope $ModuleName {
    ...
    $_approvalId = 7
    $_status = 'approved'
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/release/approvals/{0}?api-version=5.0-preview' -f $_approvalId)
    $_apiEndpoint = 'release-approvalId'
    ...
    Describe "Function: [$Function]" {
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Update-APApproval -Session $session -ApprovalId $_approvalId -Status $_status | Should be 'Mocked Invoke-APRestMethod'
