...
InModuleScope $ModuleName {
    ...
    $_subjectDescriptor = 7
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/git/repositories/{0}?api-version=5.0-preview' -f $_subjectDescriptor)
    $_apiEndpoint = 'graph-storagekeys'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APStorageKey -Session $session -SubjectDescriptor $_subjectDescriptor | Should be 'Mocked Invoke-APRestMethod'
