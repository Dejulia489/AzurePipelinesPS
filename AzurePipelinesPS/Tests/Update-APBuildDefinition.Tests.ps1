...
InModuleScope $ModuleName {
    ...
    $template = @{ id = 7 }
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/build/definitions/{0}?api-version=5.0-preview' -f $template.Id)
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Update-APBuildDefinition -Session $session -Template $template | Should be 'Mocked Invoke-APRestMethod'
