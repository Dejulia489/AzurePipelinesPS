...
InModuleScope $ModuleName {
    ...
    $_definitionID = 7
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/release/releases?api-version=5.0-preview'
    $_apiEndpoint = 'release-releases'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                New-APRelease -Session $session -DefinitionId $_definitionID | Should be 'Mocked Invoke-APRestMethod'
