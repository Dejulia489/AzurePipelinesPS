...
InModuleScope $ModuleName {
    ...
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/projects/?api-version=5.0-preview'
    $_apiEndpoint = 'project-projects'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APProjectList -Session $session | Should be 'Mocked Invoke-APRestMethod'
