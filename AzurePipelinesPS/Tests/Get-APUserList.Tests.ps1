...
InModuleScope $ModuleName {
    ...
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/graph/users?api-version=5.0-preview'
    $_apiEndpoint = 'graph-users'
...
<#         Context 'Session' {
            ...
            It 'should accept session' {
                Get-APUserList -Session $session | Should be 'Mocked Invoke-APRestMethod'
