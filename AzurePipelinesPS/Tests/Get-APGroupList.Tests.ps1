...
InModuleScope $ModuleName {
    ...
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/graph/groups/?api-version=5.0-preview'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APGroupList -Session $session | Should be 'Mocked Invoke-APRestMethod'
