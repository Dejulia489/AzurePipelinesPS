...
InModuleScope $ModuleName {
    ...
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/distributedtask/deploymentgroups/?api-version=5.0-preview'
    $_apiEndpoint = 'distributedtask-deploymentgroups'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APDeploymentGroupList -Session $session | Should be 'Mocked Invoke-APRestMethod'
