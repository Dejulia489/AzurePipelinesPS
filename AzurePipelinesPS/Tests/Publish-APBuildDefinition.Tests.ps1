...
InModuleScope $ModuleName {
    ...
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/build/definitions?api-version=5.0-preview'
    $_apiEndpoint = 'build-definitions'
    ...
    Describe "Function: [$Function]" {
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Publish-APBuildDefinition -Session $session -Template $template | Should be 'Mocked Invoke-APRestMethod'
