...
InModuleScope $ModuleName {
    ...
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/git/deletedrepositories?api-version=5.0-preview'
    $_apiEndpoint = 'git-deletedrepositories'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APDeletedRepository -Session $session | Should be 'Mocked Invoke-APRestMethod'
