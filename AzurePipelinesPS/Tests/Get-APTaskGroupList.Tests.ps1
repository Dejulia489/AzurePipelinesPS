...
InModuleScope $ModuleName {
    ...
    $_uri = 'https://dev.azure.com/myCollection/myProject/_apis/distributedtask/taskgroups?api-version=5.0-preview'
    $_apiEndpoint = 'taskgroup-taskgroups'
    ...
    Describe "Function: [$Function]" -Tag 'Pending' {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APTaskGroupList -Session $session | Should be 'Mocked Invoke-APRestMethod'
