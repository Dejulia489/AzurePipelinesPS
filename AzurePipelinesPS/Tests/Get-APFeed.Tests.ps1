...
InModuleScope $ModuleName {
    ...
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/packaging/feeds/{0}?api-version=5.0-preview' -f $_feedId)
    $_apiEndpoint = 'feed-feedId'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APFeed -Session $session -FeedId $_feedId | Should be 'Mocked Invoke-APRestMethod'
