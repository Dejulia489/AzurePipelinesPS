...
InModuleScope $ModuleName {
    ...
    $_template = @{ id = 10 }
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/build/builds/{0}?api-version=5.0-preview' -f $_template)
    ...
    Describe "Function: [$Function]" {
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Update-APBuild -Session $session -Template $_template | Should be 'Mocked Invoke-APRestMethod'
