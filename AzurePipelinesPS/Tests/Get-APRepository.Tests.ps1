...
InModuleScope $ModuleName {
    ...
    $_repositoryId = 7
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/git/repositories/{0}?api-version=5.0-preview' -f $_repositoryId)
    $_apiEndpoint = 'git-repositoryId'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APRepository -Session $session -RepositoryId $_repositoryId | Should be 'Mocked Invoke-APRestMethod'
