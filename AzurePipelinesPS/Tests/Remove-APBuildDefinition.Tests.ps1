...
InModuleScope $ModuleName {
    ...
    $_definitionId = 7 
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/build/definitions/{0}?api-version=5.0-preview' -f $_definitionId)
    $_apiEndpoint = 'build-definitionId'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Remove-APBuildDefinition -Session $session -DefinitionId $_definitionId | Should be 'Mocked Invoke-APRestMethod'
