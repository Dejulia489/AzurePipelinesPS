...
InModuleScope $ModuleName {
    ...
    $_userDescriptor = 7
    $_uri = ('https://dev.azure.com/myCollection/myProject/_apis/graph/users/{0}?api-version=5.0-preview' -f $_userDescriptor)
    $_apiEndpoint = 'graph-userId'
    ...
    Describe "Function: [$Function]" {   
        ...
        Context 'Session' {
            ...
            It 'should accept session' {
                Get-APUser -Session $session -UserDescriptor $_userDescriptor | Should be 'Mocked Invoke-APRestMethod'
