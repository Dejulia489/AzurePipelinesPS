...
FunctionsToExport = 'Add-APBuildLease', 'Add-APCheckConfiguration', 
               ...
               'Add-APLogFile', 'Add-APPool', 'Add-APQueue', 'Add-APTeamIteration', 
               'Add-APTestResult', 'Add-APVariableGroup', 'Add-APWidget', 
               'Copy-APDashboard', 'Copy-APNode', 'Copy-APQuery', 'Copy-APTeam', 
               'Find-APPSModule', 'Format-APTemplate', 'Get-APAccessControlListList', 
               'Get-APAgent', 'Get-APAgentList', 'Get-APApiVersion', 
               'Get-APApprovalList', 'Get-APBoard', 'Get-APBoardList', 'Get-APBuild', 
               'Get-APBuildArtifactList', 'Get-APBuildDefinition', 
               'Get-APBuildDefinitionList', 'Get-APBuildLease', 
               'Get-APBuildLeaseList', 'Get-APBuildList', 'Get-APBuildTimeline', 
               'Get-APBuildWorkItemList', 'Get-APCheckConfiguration', 
               ...
               'Get-APPipelineRun', 'Get-APPipelineRunList', 'Get-APPlan', 
               'Get-APPlanList', 'Get-APPolicyConfiguration', 
               ...
               'Get-APTestPlanList', 'Get-APTestPointByQuery', 'Get-APTestResult', 
               'Get-APTestResultList', 'Get-APTestRun', 'Get-APTestRunAttachment', 
               'Get-APTestRunByQuery', 'Get-APTestRunList', 
               'Get-APTestRunStatistics', 'Get-APTestSuite', 'Get-APTestSuiteList', 
               'Get-APTestSuiteListByPlanId', 'Get-APTestSuiteListByTestCaseId', 
               'Get-APTestSuiteTestCase', 'Get-APTestSuiteTestCaseList', 
               'Get-APTestSuiteTestPointList', 'Get-APUser', 
               'Get-APUserEntitlementList', 'Get-APUserList', 'Get-APVariableGroup', 
               'Get-APVariableGroupList', 'Get-APWidget', 'Get-APWidgetList', 
               'Get-APWorkItem', 'Get-APWorkItemList', 'Get-APWorkItemStateList', 
               'Get-APWorkItemTypeCategoriesList', 'Get-APWorkItemTypeList', 
               'Get-APWorkItemUpdateList', 'Install-APAgent', 'Install-APPSModule', 
               'Invoke-APGitClone', 'Invoke-APNugetPackageDownload', 
               'Invoke-APPipeline', 'Invoke-APPolicyEvaluation', 'Invoke-APQuery', 
               'Invoke-APRestMethod', 'Invoke-APServiceEndpointProxyRequest', 
               'Invoke-APWebRequest', 'New-APBuild', 'New-APDashboard', 
               'New-APEnvironment', 'New-APEnvironmentApproval', 'New-APFeed', 
               'New-APField', 'New-APGitBranch', 'New-APGitPullRequest', 'New-APGroup', 
               ...
               'Save-APFile', 'Save-APPermissionReport', 'Save-APSession', 
               ...
               'Update-APBuildDefinition', 'Update-APCheckConfiguration', 
               ...
               'Update-APReleaseSummary', 'Update-APServiceEndpoint', 
