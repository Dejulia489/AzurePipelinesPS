...
FunctionsToExport = 'Add-APDeploymentGroup', 'Add-APLogFile', 'Add-APVariableGroup', 
               'Add-APWidget', 'Find-APPSModule', 'Format-APTemplate', 
               'Get-APAccessControlListList', 'Get-APApiVersion', 
               'Get-APApprovalList', 'Get-APBuild', 'Get-APBuildDefinition', 
               'Get-APBuildDefinitionList', 'Get-APBuildList', 'Get-APDashboardList', 
               'Get-APDeletedRepository', 'Get-APDeploymentGroup', 
               'Get-APDeploymentGroupList', 'Get-APDeploymentList', 'Get-APFeed', 
               'Get-APFeedList', 'Get-APGitItem', 'Get-APGitPullRequestList', 
               'Get-APGitRefList', 'Get-APGroup', 'Get-APGroupEntitlementsList', 
               'Get-APGroupList', 'Get-APInstalledExtension', 
