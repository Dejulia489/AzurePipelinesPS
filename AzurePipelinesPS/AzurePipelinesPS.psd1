...
FunctionsToExport = 'Add-APDeploymentGroup', 'Add-APField', 'Add-APGroupMembership', 
               ...
               'Get-APTeamList', 'Get-APTeamListAll', 'Get-APTeamSettings', 
               'Get-APTestPlan', 'Get-APTestPlanList', 'Get-APTestResult', 
               'Get-APTestResultList', 'Get-APTestRun', 'Get-APTestRunList', 
               'Get-APTestRunStatistics', 'Get-APTestSuiteList', 'Get-APUser', 
