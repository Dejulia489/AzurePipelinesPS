...
FunctionsToExport = 'Add-APBuildLease', 'Add-APCheckConfiguration', 
               ...
               'Add-APLogFile', 'Add-APPool', 'Add-APQueue', 'Add-APTestResult', 
               'Add-APVariableGroup', 'Add-APWidget', 'Copy-APDashboard', 
               'Copy-APNode', 'Copy-APQuery', 'Copy-APTeam', 'Find-APPSModule', 
               'Format-APTemplate', 'Get-APAccessControlListList', 'Get-APAgent', 
               'Get-APAgentList', 'Get-APApiVersion', 'Get-APApprovalList', 
               'Get-APBoard', 'Get-APBoardList', 'Get-APBuild', 
