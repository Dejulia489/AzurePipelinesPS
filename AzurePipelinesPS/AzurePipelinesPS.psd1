...
FunctionsToExport = 'Add-APDeploymentGroup', 'Add-APVariableGroup', 'Add-APWidget', 
               ...
               'Get-APSession', 'Get-APSourceProviderList', 'Get-APStorageKey', 
               'Get-APTarget', 'Get-APTargetList', 'Get-APTaskGroupList', 
               'Get-APTeamList', 'Get-APUser', 'Get-APUserList', 'Get-APVariableGroup', 
               'Get-APVariableGroupList', 'Get-APWidget', 'Get-APWidgetList', 
               'Install-APAgent', 'Install-APPSModule', 
               'Invoke-APNugetPackageDownload', 'Invoke-APRestMethod', 'New-APBuild', 
               'New-APDashboard', 'New-APFeed', 'New-APGitBranch', 
               'New-APNotificationSubscription', 'New-APRelease', 'New-APRepository', 
               ...
               'Remove-APNugetPackageVersionFromRecycleBin', 'Remove-APRelease', 
               'Remove-APReleaseDefinition', 'Remove-APSession', 'Remove-APTarget', 
               'Remove-APVariableGroup', 'Save-APSession', 'Set-APBuildNumber', 
