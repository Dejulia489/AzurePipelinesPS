...
FunctionsToExport = 'Add-APDeploymentGroup', 'Add-APVariableGroup', 'Add-APWidget', 
               'Find-APPSModule', 'Format-APTemplate', 'Get-APApiVersion', 
               ...
               'Get-APDeploymentGroupList', 'Get-APFeed', 'Get-APFeedList', 
               'Get-APGitItem', 'Get-APGroup', 'Get-APGroupEntitlementsList', 
               ...
               'Get-APRepository', 'Get-APRepositoryList', 'Get-APSession', 
               'Get-APStorageKey', 'Get-APTarget', 'Get-APTargetList', 
