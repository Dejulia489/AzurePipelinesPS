...
FunctionsToExport = 'Add-APDeploymentGroup', 'Add-APVariableGroup', 'Format-APTemplate', 
               ...
               'Get-APPackage', 'Get-APPackageList', 'Get-APProjectList', 
               'Get-APQueue', 'Get-APRelease', 'Get-APReleaseDefinition', 
               'Get-APReleaseDefinitionList', 'Get-APReleaseList', 
               'Get-APRepository', 'Get-APRepositoryList', 'Get-APSession', 
               'Get-APTarget', 'Get-APTargetList', 'Get-APTaskGroupList', 'Get-APUser', 
               'Get-APUserList', 'Get-APVariableGroup', 'Get-APVariableGroupList', 
               'Install-APAgent', 'Invoke-APRestMethod', 'New-APBuild', 
               ...
               'Save-APSession', 'Update-APBuildDefinition', 
               'Update-APDeploymentGroup', 'Update-APRelease', 
