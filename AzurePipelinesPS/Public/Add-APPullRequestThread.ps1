function Add-APPullRequestThread
{
    <#
    .SYNOPSIS
    ...
    The status of the pull request thread.
    ...
    process
    {
        ...
        $apiEndpoint = (Get-APApiEndpoint -ApiType 'git-pullRequests-threads') -f $RepositoryId, $PullRequestId
        $setAPUriSplat = @{
