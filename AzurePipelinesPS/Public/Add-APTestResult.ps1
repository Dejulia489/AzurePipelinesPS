function Add-APTestResult
{
    <#
    .SYNOPSIS

    Creates a an Azure Pipeline test result.
    ...
    The id of the run to attach the test result to.
    ...
    Adds a test result to a test run.
    ...
    Add-APTestResult -Instance 'https://dev.azure.com' -Collection 'myCollection' -Project 'myFirstProject' -RunId 7 -TestResult $testResult

    .LINK

    https://learn.microsoft.com/en-us/rest/api/azure/devops/test/results/add?view=azure-devops-rest-7.1&tabs=HTTP
    #>
