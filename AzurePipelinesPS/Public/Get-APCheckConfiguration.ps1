function Get-APCheckConfiguration
{
    <#
    .SYNOPSIS
    ...
    Returns the check configuration with the id of 15.

    Get-APCheckConfiguration -Session $session -Id 15 -Expand settings

    .LINK

    https://learn.microsoft.com/en-us/rest/api/azure/devops/approvalsandchecks/check-configurations/get?view=azure-devops-rest-7.0&tabs=HTTP
    #>
