function Get-APTestSuiteTestCaseList
{
    <#
    .SYNOPSIS

    Returns a list of Azure Pipelines test cases for a given test suite id.
    ...
    Get-APTestSuiteTestCaseList -Instance 'https://dev.azure.com' -Collection 'myCollection' -Project 'myFirstProject' -PlanId 8 -SuiteId 9 -ApiVersion '7.1-preview.3'

    .LINK

    https://learn.microsoft.com/en-us/rest/api/azure/devops/testplan/suite-test-case/get-test-case-list?view=azure-devops-rest-7.1
    #>
    ...
    process
    {
        ...
        If ($results.continuationToken -and (-not($PSBoundParameters.ContainsKey('Top'))))
        {
            ...
            Get-APTestSuiteTestCaseList @PSBoundParameters -ContinuationToken $results.continuationToken
        }
        If ($results.value)
        {
