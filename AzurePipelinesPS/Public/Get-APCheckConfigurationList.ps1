function Get-APCheckConfigurationList
{
    <#
    .SYNOPSIS

    Returns a list of Azure Pipelines check configurations by resource type and id.
    ...
    Returns all checks configured for the environment with the resource id of 158

    Get-APCheckConfigurationList -Session $session -ResourceId 158 -ResourceType environment -Expand settings

    .LINK

    https://learn.microsoft.com/en-us/rest/api/azure/devops/approvalsandchecks/check-configurations/list?view=azure-devops-rest-7.0&tabs=HTTP
    #>
